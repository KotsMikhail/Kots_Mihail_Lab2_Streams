...
public class CompressionIOTest {
    ...
    private static final String test1 = "Привет, мир!";
    ...
    private void checkInformationIntegrity(String str) throws IOException {
        OutputStream code = new ByteArrayOutputStream(2 * str.length());
        CompressionOutputStream os = new CompressionOutputStream(code);
        os.write(str.getBytes());
        os.flush();
        CompressionInputStream is = new CompressionInputStream(new ByteArrayInputStream(code.toString().getBytes()));
